LOCAL_ADDITIONAL_DEPENDENCIES += $(LOCAL_PATH)/crypto.mk
...
CRYPTO_LOCAL_SRC_FILES := $(CRYPTO_CSOURCES)
#$(addprefix crypto/,$(CRYPTO_CSOURCES))
#\
#						  $(addprefix engines/,$(GOST_SRC))
						  
CRYPTO_LOCAL_C_INCLUDES += $(LOCAL_PATH) \
                    $(LOCAL_PATH)/. \
                    $(LOCAL_PATH)/include \
...
LOCAL_SRC_FILES := $(CRYPTO_CSOURCES)
#$(arm_src_files))

LOCAL_SRC_FILES_arm += $(filter-out $(arm_exclude_files),$(CRYPTO_CSOURCES) $(arm_src_files))
LOCAL_CFLAGS_arm += $(arm_cflags)
LOCAL_CLANG_ASFLAGS_arm += $(arm_clang_asflags)

LOCAL_SRC_FILES_arm64 += $(filter-out $(arm64_exclude_files),$(CRYPTO_CSOURCES) $(arm64_src_files))
LOCAL_CFLAGS_arm64 += $(arm64_cflags)
LOCAL_CLANG_ASFLAGS_arm64 += $(arm64_clang_asflags)

LOCAL_SRC_FILES_x86 += $(filter-out $(x86_exclude_files),$(CRYPTO_CSOURCES) $(x86_src_files))
LOCAL_CFLAGS_x86 += $(x86_cflags)
LOCAL_CLANG_ASFLAGS_x86 += $(x86_clang_asflags)

LOCAL_SRC_FILES_x86_64 += $(filter-out $(x86_64_exclude_files),$(CRYPTO_CSOURCES) $(x86_64_src_files))
